...
public class transactionHistorySellsUpdate implements Runnable {
	
	private Gw2DatabaseManager connected;
	Table tableType=TableFactory.getTable(TableType.GW2TransactionHistorySells);
	public  transactionHistorySellsUpdate(Gw2DatabaseManager input) {
