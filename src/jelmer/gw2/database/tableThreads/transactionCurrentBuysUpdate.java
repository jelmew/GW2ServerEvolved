...
public class transactionCurrentBuysUpdate implements Runnable {
	
	private Gw2DatabaseManager connected;
	Table tableType=TableFactory.getTable(TableType.GW2TransactionCurrentBuys);
	public  transactionCurrentBuysUpdate(Gw2DatabaseManager input) {
