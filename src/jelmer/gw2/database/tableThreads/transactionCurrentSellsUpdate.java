...
public class transactionCurrentSellsUpdate implements Runnable {
	
	private Gw2DatabaseManager connected;
	Table tableType=TableFactory.getTable(TableType.GW2TransactionCurrentSells);
	public  transactionCurrentSellsUpdate(Gw2DatabaseManager input) {
